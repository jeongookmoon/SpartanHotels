      ...
      <div className="hotel-search-container">
      			...
      			<FormGroup className="form-inline hotel-search-inputs">
		  			  ...
		  			  <div className="col-lg-3 input-group home-location">
		  			    <div className="input-group-append">
		  			      <div className="location-input-icon input-group-text"><i className="fa fa-search"></i></div>
		  			    	...
		  			    	<input name="city" ref={this.autocompleteInput} id="autocomplete" value={toTitleCase(this.state.city)} onChange={this.handleChange} type="text" className="location-input form-control"></input>
		  			  </div>
	  			      ...
	  			      <div className="col-lg-2 input-group home-date">
	  			          ...
	  			          <input name="date_in" type="text" value={this.state.date_in} onChange={this.handleChange} className="check-in-input form-control"/>
	  			      </div>
	  			      ...
	  			      <div className="col-lg-2 input-group home-date">
	  			          ...
	  			          <input name="date_out" type="text" value={this.state.date_out} onChange={this.handleChange} className="check-in-input form-control"/>
	  			      </div>
