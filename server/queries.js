 ...
 */
  transaction: {
    getRoomInfo: `SELECT T.*, group_concat(TR.transaction_room_id) as transaction_room_ids, group_concat(TR.room_id) as room_ids, ANY_VALUE(TR.room_price), ANY_VALUE(R.hotel_id), group_concat(R.room_number), R.bed_type, ANY_VALUE(R.capacity), ANY_VALUE(RI.url) as image,
                  COUNT(*) as quantity
