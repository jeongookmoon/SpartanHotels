...
describe('hotel search',()=>{
    describe('pagination',()=>{
        ...
        test('10 results, 3 resultsPerPage, page 0', ()=>{
            return axios.get(hotelSearch, 
        ...
        test('10 results, 3 resultsPerPage, page 3', ()=>{
            return axios.get(hotelSearch, 
        ...
        test('10 results, 3 resultsPerPage, page 4', ()=>{
            return axios.get(hotelSearch, 
        ...
        test('9 results, 2 resultsPerPage, page 1', ()=>{
            return axios.get(hotelSearch, 
                {params:{date_in:"2019-03-14", date_out:"2019-03-21", resultsPerPage:2}})
            .then( 
                response=>{
                    expect(response.status).toEqual(200)
                    expect(response.data.totalResultCount).toEqual(9)
        ...
        test('9 results, 2 resultsPerPage, page 100', ()=>{
            return axios.get(hotelSearch, 
        ...
        test('9 results, 200 resultsPerPage, page 0', ()=>{
            return axios.get(hotelSearch, 
            ...
            .then( 
                response=>{
                    expect(response.status).toEqual(200)
                    expect(response.data.totalResultCount).toEqual(9)
                    expect(response.data.results.length).toEqual(9)
                },
                err=>{
                }
            )
        })
        test('9 results, 200 resultsPerPage, page 1', ()=>{
            return axios.get(hotelSearch, 
        ...
        test('default resultsPerPage & default pageNumber when >10 total results', ()=>{
            ...
            .then( 
                response=>{
                    throw "cant test properly until we have more than 10 total results in db"
