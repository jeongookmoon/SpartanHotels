...
-- -----------------------------------------------------
-- Table `spartanhotel`.`rewards`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spartanhotel`.`rewards` ;

CREATE TABLE IF NOT EXISTS `spartanhotel`.`rewards` (
  `rewards_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
